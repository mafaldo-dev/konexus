...
export default function NotificationPreferences() {
  ...
  useEffect(() => {
    ...
    const demoMessages: Message[] = [
      {
        id: '1',
        sector: 'CRM',
        sender: 'Sistema de Leads',
        message: 'Novo lead cadastrado: João Silva - interessado em nosso serviço premium. Cliente potencial alto valor.',
      ...
      },
      {
        id: '2',
        sector: 'Estoque',
        sender: 'Controle de Estoque',
        message: 'Produto XYZ atingiu estoque mínimo (5 unidades restantes). Favor solicitar reposição ao fornecedor.',
      ...
      },
      {
        ...
        message: 'Venda #1234 no valor de R$ 2.450,00 finalizada com sucesso. Cliente optou por pagamento à vista.',
        timestamp: 'Ontem, 15:42',
        read: true,
        priority: 'low'
      },
      {
        ...
        message: 'Fatura #5678 no valor de R$ 3.200,00 vence em 3 dias. Favor verificar pagamento com o cliente.',
      ...
      },
      {
        ...
        sector: 'Expedição',
        sender: 'Logística',
        message: 'Pedido #8910 enviado para transporte. Código de rastreio: AB123456789BR. Previsão de entrega: 3 dias úteis.',
    ...
    const storedMessages = localStorage.getItem('sector_messages') || JSON.stringify(demoMessages);
                      ...
                      <label className="flex items-center justify-between cursor-pointer">
                        ...
                        <div className="relative">
                          ...
                          <div className={`dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition ${
                            notificationSound ? 'transform translate-x-6' : ''
                          }`}></div>
                        </div>
                      </label>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {(['email', 'push', 'sms'] as const).map(channel => (
                        <div key={channel} className={`p-3 rounded-lg flex items-center gap-3 ${
                      ...
                      <div key={category} className={`p-4 rounded-lg ${
                        ...
                        <h4 className="font-medium mb-2 flex items-center gap-2">
                          <span className={`inline-block w-3 h-3 rounded-full ${
                            sectorColors[category]?.replace('bg-', 'bg-opacity-100 ') || 'bg-gray-300'
                          }`}></span>
                          {category}
                        </h4>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className={`flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center ${
                        sectorColors[msg.sector] || sectorColors.default
                      }`}>
                        {msg.sector.charAt(0)}
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2">
                          <h3 className={`text-sm font-medium truncate ${
                            !msg.read ? (darkMode ? 'text-white' : 'text-gray-900') : (darkMode ? 'text-gray-300' : 'text-gray-600')
                          }`}>
                            {msg.sender}
                          </h3>
                        ...
                        <p className={`text-sm mt-1 ${
                          !msg.read ? (darkMode ? 'text-gray-100' : 'text-gray-800') : (darkMode ? 'text-gray-400' : 'text-gray-600')
                        }`}>
