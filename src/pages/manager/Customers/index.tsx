...
import { deleteCustomer, handleAllCustomers } from "../../../service/api/Administrador/customer/clients"
import { Customer } from "../../../service/interfaces"
import Dashboard from "../../../components/dashboard/Dashboard"
import FormAdd from './Form-add'
import EditForm from './modal-edit'
import { Filter, Search, MapPin, Edit, DeleteIcon, Plus, X } from "lucide-react"
                ...
                <table className="w-full">
                  <thead className="bg-slate-800 text-white">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide">Cidade</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide">Logradouro</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide">Numero</th>
                    ...
                    {filteredCustomers.length === 0 ? (
                      ...
                      filteredCustomers.map((customer) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-sm text-gray-700">{customer.address.street}</td>
                          <td className="px-4 py-3 text-sm text-gray-700">{customer.address.number}</td>
