...
export const EditAccountForm: React.FC<EditAccountFormProps> = ({ account, onSave, onCancel }) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-lg">
        <div className="h-12 w-12 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600">
          {getAccountIcon(formData.tipo)}
        </div>
        <div>
          <h3 className="font-semibold text-slate-900">Editar Conta Bancária</h3>
          <p className="text-sm text-slate-600">Atualize as informações da sua conta</p>
        </div>
      </div>
